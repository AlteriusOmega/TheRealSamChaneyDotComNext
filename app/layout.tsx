  ...
  return (
    <html lang="en">
      <body className="">
        ...
        <div className="flex scrollbar-hide h-[calc(100vh-160px)] overflow-auto">
          {/* <div className=" bg-darkTextPrimary mt-9">TEST</div> */}
          <div className="gradient-text frame-brace left sticky pl-2 pr-6 top-[15vh]">{"{"}</div>
          ...
          <div className="gradient-text frame-brace right sticky pr-2 pl-6 top-[15vh]">{"}"}</div>
        </div>
      </body>
    </html>
  )
